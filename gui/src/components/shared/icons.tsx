...
type IconName = "home" | "completed" | "categories" | "calendar"| "calendars"
...
const Calendars = ({ color = "black", height = 20, width = 20 }: IconProps) => (
...
const Icons = ({
  ...
  switch (name) {
    ...
    case "calendars":
      return <Calendars color={color} height={height} width={width} />
  }
}
